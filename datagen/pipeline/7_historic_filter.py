...
def main():
    parser = argparse.ArgumentParser(description='Convert percentage of dataset images (LoveDA, DeepGlobe, iSAID) to historic effects')
    parser.add_argument('--base-dir', default='dataset/patches', 
                       help='Base directory containing train/val subdirectories')
    parser.add_argument('--percentage', type=float, default=5.0,
                       help='Percentage of dataset images to convert (default: 5.0)')
    ...
    # Clean up existing _5 images unless --no-cleanup is specified
    ...
    # Save processed images as new files with _5 suffix
    print(f"\nSaving processed images as new files with _5 suffix...")
