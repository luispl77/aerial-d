...
\midrule
\raisebox{-0.5\height}{\includegraphics[width=3.5cm, height=3.5cm]{isaid.png}} & 
\hspace{-0.5cm}\parbox[c]{8cm}{Contains \textbf{2,806} high resolution images at varying widths of 800 to 13,000 pixels, spatial resolution of \textbf{0.1m to 4.5m}, with \textbf{655,451} instances across 15 object classes.} \\[0.5cm]
\midrule
\multicolumn{2}{c}{\textbf{LoveDA Dataset}} \\
\midrule
\raisebox{-0.5\height}{\includegraphics[width=3.5cm, height=3.5cm]{loveda.png}} & 
\hspace{-0.5cm}\parbox[c]{8cm}{Contains \textbf{5,987} images at \textbf{1024} pixel width, spatial resolution of \textbf{0.3m}, with -- instances across 5 land cover classes.} \\[0.5cm]
\bottomrule
\end{tabular}
\end{table}
