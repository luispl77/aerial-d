...
\cleardoublepage
%
%Chapter 7 - Removed (content merged into Chapter 6)
%
% -----------------------------------------------------------------------------
% BIBLIOGRAPHY
...
\bibliography{./Thesis-MSc-Bibliography,../article/ExtendedAbstract_ref_db} % Merge dissertation and article bibliographies
%
