...
% Enable hyperlinks and PDF bookmarks (load last)
% - Makes citations, refs, and URLs clickable
% - Generates a PDF outline (bookmarks) for sections/subsections
\usepackage[hidelinks,bookmarksopen=true,bookmarksnumbered=true]{hyperref}
\hypersetup{
  pdftitle={Open-Vocabulary Semantic Segmentation of Aerial Photos},
