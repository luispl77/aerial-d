...
\midrule
\multirow{2}{*}{\textbf{AERIAL-D}} & \multirow{2}{*}{\textbf{0.3m-4.5m}} & \multirow{2}{*}{\textbf{37,288}} & \textbf{1,482,847} & -- & \textbf{\checkmark} & \textbf{\checkmark} & \multirow{2}{*}{\textbf{480}} & \multirow{2}{*}{\textbf{Automated + LLM}} \\
 & & & -- & \textbf{39,676} & $\times$ & \textbf{\checkmark} & & \\
\bottomrule
\end{tabular}%
}
\end{table*}
