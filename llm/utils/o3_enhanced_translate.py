            ...
            "properties": {
                ...
                "translations": {
                    ...
                    "properties": {
                        "selected_expression": {
                            "type": "string",
                            "description": "The expression selected for translation"
                        },
                        "es": {
                            "type": "string",
                    ...
                    "required": ["selected_expression", "es", "zh", "pt", "fr", "de", "ja", "ru", "ar", "hi", "it"],
                    "additionalProperties": False
                }
            },
            "required": ["enhanced_expressions", "unique_description", "unique_expressions", "translations"],
            "additionalProperties": False
        }
    }
}
...
def create_prompt(object_name, original_expressions):
    """Create the detailed prompt for O3 with translation instructions."""
    ...
    system_prompt = (
        ...
        "1. From all the expressions you have created (original, variations, and unique), select ONE expression that you think is the most clear and descriptive\n"
        "2. Translate this selected expression into the following languages:\n"
        "   - Spanish (es)\n"
        "   - Chinese (zh)\n"
        "   - Portuguese (pt)\n"
        "   - French (fr)\n"
        ...
        "   - Hindi (hi)\n"
        "   - Italian (it)\n"
        "3. Ensure translations maintain the spatial and descriptive information\n"
        "4. Use natural, native-speaker level language for each translation\n\n"
        ...
        "  ],\n"
        "  \"translations\": {\n"
        "    \"selected_expression\": \"<the expression you chose to translate>\",\n"
        ...
        "Write all the expressions using lowercase letters and no punctuation except for the translations which should follow proper language conventions."
    )
    
    user_prompt = (
        f"Create language variations of the provided expressions while preserving spatial information, "
        f"analyze the spatial context for uniqueness factors, generate new unique expressions for this {object_name} "
        "(highlighted with a red bounding box), and translate one selected expression into multiple languages."
    )
...
def process_single_object(object_info, client, args):
    ...
    try:
        ...
        print(f"Translated expression: {enhanced_data.translations.selected_expression}")
